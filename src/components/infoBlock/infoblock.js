    ...
    <>
      <div className='info-us-main'>
        <div className='row'>
          {!isSmallScreen ? (
            <>
              <div className={`col-md-5 ${infoImgBlock} order-${pos1}`}>
                {!isRevert ? (
                  <>
              ...
              <div className={`col-md-4 info-text-block  order-first order-${pos2}`}>
                {isArrow ? (
              ...
              <div className={`col-md-3 info-back-image d-none d-md-block order-${pos3}`}>
                {!isRevert ? (
            ...
            <>
              <div className="col-md-5 ${infoImgBlock} order-1">
                {!isRevert ? (
                  <>
                    <div className='infoimg-border'></div>
                    <div className='info-overlay'>
              ...
              <div className="col-md-4 info-text-block  order-first order-2">
                {isArrow ? (
                  <div className='arow-block d-none d-sm-block'>
                    <img src={arrowImage} alt="Arrow image" class="img-fluid"></img>
                  </div>
              ...
              <div className="col-md-3 info-back-image d-none d-md-block order-3">
                {!isRevert ? (
                  <img src={backImage} alt="Background image" class="back-image-vector img-fluid w-100"></img>
                ) : (
                  <img src={backImage} alt="Background image" class="back-image-vector mirrow img-fluid w-100"></img>
